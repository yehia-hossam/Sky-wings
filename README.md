# ✈️ Skywings - Travel & Tourism Website
...
- **HTML5:** Semantic markup structure for the entire layout.
- **CSS3:** Modern styling utilizing Flexbox and CSS Grid for full responsiveness across all screen sizes.
- **JavaScript (ES6+):** Dynamic elements, interactive navigation, and smooth user interactions.
...
├── assets/            
│   ├── images/        # Website screenshots, destination photos & icons
│   └── css/           # Stylesheets (style.css)
└── js/                
    └── main.js        # Interactive frontend scripts
